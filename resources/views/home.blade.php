		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="./assets/index.html"><img src="./assets/img/logo.png" alt=""></a>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am {{ $nameData ['name'] }}</h1>
							<h5 class="text-uppercase">{{ $nameData['profession'] }}</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="./assets/#"><span>Hire Me</span></a>
								<a class="primary_btn tr-bg" href="./assets/#"><span>Get CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
			...
			<div class="row justify-content-start align-items-center">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<a class="primary_btn" href="./assets/#"><span>Download CV</span></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">minimal design</a></h4>
					...
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">Paint wall</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">female light</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">fourth air</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">together sign</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">multiply fowl</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">green heaven</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="./assets/portfolio-details.html">season face</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
